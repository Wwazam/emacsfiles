  ...
  (use-package dashboard
    ...
    :config
      ...
      (setq dashboard-items '((recents  . 5)
                              (projects . 5)))
      (setq dashboard-banner-logo-title "OUIIII"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :results none
  ...
  (define-key global-map (kbd "C-c f i")
    (defun my/Init () (interactive)(find-file "~/Dropbox/document/notes/inbox.org")))
  (define-key global-map (kbd "C-c f I")
  ...
  (define-key global-map (kbd "C-c f l")
    (defun my/Diary () (interactive)(find-file "~/Dropbox/document/notes/later.org")))
