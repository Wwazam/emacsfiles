...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package evil
    ...
    :config
      ...
      (define-key evil-insert-state-map (kbd "C-.") 'ace-jump-mode)
      (define-key evil-normal-state-map (kbd "C-.") 'ace-jump-mode)
      (define-key evil-visual-state-map (kbd "C-.") 'ace-jump-mode)
      (define-key evil-motion-state-map (kbd "C-.") 'ace-jump-mode)
