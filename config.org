...
Emacs uses C-u as an universal argument (adding an intermediate checkbox in orgmode is "C-u C-u C-c C-c" for example)
Evil uses it to scroll down half a page

I remaped it to C-f that evil uses to scroll down a whole page, and that I never use myself
...
#+BEGIN_SRC emacs-lisp :results none
  ...
  (define-key global-map (kbd "C-c f a")
    (defun my/Agenda () (interactive)(find-file "~/Dropbox/document/notes/agenda.org")))
  ...
  (define-key global-map (kbd "C-c f i")
    (defun my/Inbox () (interactive)(find-file "~/Dropbox/document/notes/inbox.org")))
  (define-key global-map (kbd "C-c f I")
    (defun my/Init () (interactive)(find-file "~/.emacs.d/init.el")))
  (define-key global-map (kbd "C-c f j")
    (defun my/Diary () (interactive)(find-file "~/Dropbox/document/notes/diary.org")))
  (define-key global-map (kbd "C-c f l")
    (defun my/List () (interactive)(find-file "~/Dropbox/document/notes/list.org")))
  (define-key global-map (kbd "C-c f L")
    (defun my/Later () (interactive)(find-file "~/Dropbox/document/notes/later.org")))
  (define-key global-map (kbd "C-c f p")
    (defun my/Project () (interactive)(find-file "~/Dropbox/document/notes/project.org")))
  (define-key global-map (kbd "C-c f S")
    (defun my/Scratch () (interactive)(switch-to-buffer "*scratch*")))
  (define-key global-map (kbd "C-c f t")
    (defun my/Todo () (interactive)(find-file "~/Dropbox/document/notes/todo.org")))
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-refile-targets '(("~/Dropbox/document/notes/todo.org" :maxlevel . 3)
                             ("~/Dropbox/document/notes/later.org" :level . 1)
                             ("~/Dropbox/document/notes/agenda.org" :maxlevel . 2)))
