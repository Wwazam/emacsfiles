...
(define-key global-map (kbd "C-c f a")
  (lambda () (interactive)(find-file "~/documents/notes/agenda.org")))
...
(define-key global-map (kbd "C-c f p")
  (lambda () (interactive)(find-file "~/documents/notes/project.org")))
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-capture-templates
        '(("t" "Todo" entry (file+headline "~/documents/notes/todo.org" "Tasks")
          ...
          "* %?\n[[file:%F][%F]]")
          ("a" "Agenda" entry (file "~/documents/notes/agenda.org")
           "* %?\nEntered on %U\n  %i\n")
          ))
#+END_SRC
